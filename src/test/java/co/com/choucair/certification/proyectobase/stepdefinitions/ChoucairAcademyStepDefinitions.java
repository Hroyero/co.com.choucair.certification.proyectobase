...
public class ChoucairAcademyStepDefinitions {
    ...
    public void thanBrandonWantsToLearnAutomationAtTheAcademyChoir(List<AcademyChoucairData> academyChoucairData)throws Exception {
    ...
    public void heFindsTheCourseCalledResourcesRecursosAutomationBancolombia(List<AcademyChoucairData> academyChoucairData)throws Exception {
